...
import { BarChart3, MessageSquare, Users, Clock, TrendingUp, TrendingDown, ArrowLeft, RefreshCw } from 'lucide-react';
...
export default function StatisticsPage({ user }: { user: User | null }) {
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Métricas y análisis de rendimiento</p>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3">
                    ...
                    <div key={inbox}>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${stats.totalConversations > 0 ? (count / stats.totalConversations) * 100 : 0}%`,
                          }}
                        />
                      </div>
                    </div>
