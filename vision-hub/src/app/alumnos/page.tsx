...
export default function AlumnosPage() {
  ...
  const previewMetrics = [
    { icon: Users, label: 'Alumnos Activos', value: '—', color: '#10b981' },
    { icon: BookOpen, label: 'Cursos Activos', value: '—', color: '#3b82f6' },
    { icon: Award, label: 'Tasa Completitud', value: '—', color: '#8b5cf6' },
    { icon: AlertTriangle, label: 'Riesgo Abandono', value: '—', color: '#f59e0b' },
  ];

  const upcomingFeatures = [
    { icon: Users, text: 'Retención por cohorte' },
    { icon: BookOpen, text: 'Progreso por curso' },
    { icon: Award, text: 'Certificaciones emitidas' },
    { icon: AlertTriangle, text: 'Predicción de abandono' },
    { icon: Video, text: 'Asistencia a clases en vivo' },
    { icon: TrendingUp, text: 'NPS y satisfacción' },
  ];
      ...
      <div className="p-3 sm:p-4 lg:p-6 space-y-3 sm:space-y-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8 lg:p-10">
          <div className="text-center max-w-lg mx-auto">
            <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-2xl mb-4">
              <Construction className="w-7 h-7 sm:w-8 sm:h-8 text-emerald-600" />
            </div>
            <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">En Construcción</h2>
            <p className="text-xs sm:text-sm text-gray-500 mb-6">Este dashboard conectará con Educativa para mostrar métricas académicas.</p>
            ...
            <div className="mt-6 flex items-center justify-center gap-2 text-gray-400">
              ...
              <span className="text-[10px] sm:text-xs">Datos desde Educativa + Zoom/Vimeo</span>
            </div>
          </div>
        </div>
      </div>
