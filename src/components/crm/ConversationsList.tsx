...
export default function ConversationsList({
  ...
  const filteredConversations = conversations.filter(conv => {
    const matchesSearch = (conv.nombre || '').toLowerCase().includes(searchQuery.toLowerCase()) ||
                         (conv.telefono || '').includes(searchQuery)
            ...
            {filteredConversations.map((conversation) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`w-10 h-10 rounded-full ${getAvatarColor(conversation.nombre || 'Usuario')} flex items-center justify-center text-white font-semibold text-sm flex-shrink-0`}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      <span className="font-semibold text-sm text-gray-900 truncate">
                        {conversation.nombre || conversation.telefono || 'Sin nombre'}
                      </span>
